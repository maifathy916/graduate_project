...
<body>
    ...
    <div class="container">
        ...
        @if(count($errors) > 0)
                ...
                <script>
                    $(function(){
                        @if(count($errors) > 2 || $errors->has('fname') || $errors->has('lname')  || $errors->has('discrction') )
                        $(".divmid-login").hide();
                        $(".divmid").show();
                        @endif
            ...
            <div class="divmid hide col-lg-5 col-md-8 col-sm-10">
                ...
                <form class="px-4 py-3" action="{{route('register')}}" method="post" enctype="multipart/form-data">
                    ...
                    <div class="form-group email-div1">
                        <input type="email" class="form-control email-input1" id="exampleDropdownFormEmail1" name="email" value="{{ Request::old('lname')}}">
                    ...
                    <!--Date-->
                    <div class="form-group">
                        <input class="form-control date-input" type="date" name="brithdate">
                    </div>
                    <!--  phone-->
